...
const getMyPublishs = params =>
  Requests(`${initUrl}${GET_MY_PUBLISHS}`, params); //我的发布
const downMyPubList = params =>
  Requests(`${initUrl}${DOWN_MY_PUB_LIST}`, params); //下架我的发布
...
const DOWN_MY_PUB_LIST = "user/downmypublish";
